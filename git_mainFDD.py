...
def mainFDD(inputMatrix,sampleFreq,title,figTitle,FDDsolverTitle, peakThresh=-10000, frequencyThresh = 30, writeToFile = 0):
    ...
    plt.figure(figTitle)
    #plt.title('FDD Method',size = 38)
    #toolsAndMisc2.plotIntoLatex()
    plt.plot(Frequencies,dbs1)
